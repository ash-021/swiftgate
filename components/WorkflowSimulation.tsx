...
export default function WorkflowSimulation() {
  ...
  return (
    <div className="relative w-full max-w-[320px] mx-auto py-8">
      {/* Ambient Backlight */}
      <motion.div
        animate={{ opacity: [0.5, 0.8, 0.5], scale: [0.95, 1.05, 0.95] }}
        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
        className="absolute inset-0 bg-emerald-500/10 blur-[80px] rounded-full pointer-events-none"
      />
      ...
      <motion.div
        animate={{ y: [-8, 8, -8] }}
        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
        className="relative bg-neutral-950 rounded-[38px] p-3 border border-neutral-700/50 shadow-[inset_0_0_2px_1px_rgba(255,255,255,0.1),0_20px_40px_-10px_rgba(0,0,0,0.8)] text-neutral-100 font-sans select-none"
      >
        ...
        {/* Screen Viewport */}
        <div className="h-[460px] bg-neutral-900 rounded-[28px] overflow-hidden relative flex flex-col justify-between p-4 border border-neutral-800">
          {/* Glass Glare Overlay */}
          <div className="absolute inset-0 bg-gradient-to-tr from-white/0 via-white/[0.03] to-white/10 pointer-events-none z-50" />
          ...
          <AnimatePresence mode="wait">
            ...
            {phase === 0 && (
              <motion.div
                ...
                className="flex-1 flex flex-col justify-between pt-4 relative z-10"
              >
                {/* WhatsApp Push Banner */}
                <div className="bg-neutral-800/90 border border-neutral-700 rounded-2xl p-3.5 shadow-xl backdrop-blur-md">
                  <div className="flex items-center justify-between mb-1.5">
                    <div className="flex items-center gap-1.5">
                      <div className="w-4 h-4 rounded bg-emerald-600 flex items-center justify-center">
                        <MessageSquare className="w-2.5 h-2.5 text-white" />
                      </div>
                      <span className="text-[11px] font-semibold text-neutral-200">WhatsApp</span>
                    </div>
                    <span className="text-[10px] text-neutral-400">now</span>
                  </div>
                  <p className="text-[11px] font-bold text-white">Grand Central Hotel</p>
                  <p className="text-[10px] text-neutral-300 leading-snug mt-0.5">
            ...
            {phase === 1 && (
              ...
              >
                <div>
                  ...
                  <p className="text-[11px] text-neutral-300 mt-2 font-medium">Scanning Government ID...</p>

                  {/* ID Card Wireframe */}
                  <div className="mt-3 bg-neutral-950 border border-neutral-800 rounded-xl p-3 relative overflow-hidden shadow-inner">
                    {/* Laser Scan Line Animation */}
                    <motion.div
                      initial={{ top: "0%" }}
                      animate={{ top: "100%" }}
                      transition={{ duration: 1.2, repeat: Infinity, ease: "linear" }}
                      className="absolute left-0 right-0 h-[2px] bg-emerald-400 shadow-[0_0_8px_#34d399] z-20"
                    />
            ...
            {phase === 2 && (
              ...
              >
                <div>
                  ...
                  <p className="text-[11px] text-neutral-300 mt-2">Matching live face to ID document...</p>
                  ...
                  <div className="mt-4 w-28 h-28 mx-auto rounded-full border-2 border-dashed border-emerald-500/70 flex items-center justify-center relative">
                    <motion.div
                      ...
                      className="w-24 h-24 rounded-full bg-neutral-950 flex items-center justify-center text-neutral-600 shadow-inner"
                    >
                ...
                <div className="bg-neutral-950 border border-neutral-800 p-2 rounded-lg text-center font-mono text-[10px] text-neutral-300">
            ...
            {phase === 3 && (
              <motion.div
                ...
                exit={{ opacity: 0 }}
                transition={{ duration: 0.3 }}
                className="flex-1 flex flex-col justify-between text-center pt-2 relative z-10"
              >
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-neutral-300 mt-0.5">Written directly to Hotel PMS</p>
                  </div>

                  <div className="bg-neutral-950 border border-neutral-800 rounded-xl p-3 text-left space-y-1.5 shadow-inner">
            ...
            {phase === 4 && (
              <motion.div
                ...
                className="flex-1 flex flex-col justify-between pt-4 relative z-10"
              >
                <div className="bg-neutral-800/90 border border-neutral-700 rounded-2xl p-3.5 shadow-xl">
                  ...
                  <div className="mt-2 bg-neutral-950 border border-neutral-800 p-2 rounded text-center shadow-inner">
